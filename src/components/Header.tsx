...
export function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-background/80 backdrop-blur-md py-2" : "bg-transparent py-3"}`}
    >
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <Link
              href="#contact"
              onClick={() => setMobileMenuOpen(false)}
              className="mt-8 text-lg font-medium bg-black text-white px-8 py-3 rounded-full hover:bg-gray-800 transition-colors"
            >
              Book a Shoot
            </Link>
          </motion.div>
